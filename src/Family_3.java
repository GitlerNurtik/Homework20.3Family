public class Family_3 implements rent{
    private String name;
    ...
    public Family_3(String name, String familyMember1, String familyMember2, String familyMember3, String familyMember4) {
        this.name = name;
        FamilyMember1 = familyMember1;
        FamilyMember2 = familyMember2;
        FamilyMember3 = familyMember3;
    ...
    public void pay() {
        System.out.println("""
                Семья живущая в общежитии, платит аренду в размере: 27000руб. в месяц\s
    ...
    public String toString() {
        return "В семье, живущей в общежитии, проживают 4 члена семьи: \n " +
                getFamilyMember1() +"\n"+
                getFamilyMember2() +"\n"+
                getFamilyMember3() +"\n"+
                getFamilyMember4();
